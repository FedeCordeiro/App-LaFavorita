...
export class ProductosComponent {
  productos = [
    ...
    { id: 7, nombre: 'Sandwich de miga', descripcion: 'Pan fino y esponjoso, ideal para sándwiches fríos.', precio: 300, imagen: 'assets/img/productos/sandwich.jpg' },
    ...
    { id: 12, nombre: 'Facturas', descripcion: 'Variedad de medialunas dulces y saladas.', precio: 180, imagen: 'assets/img/productos/medialunas.jpg' },
    ...
    { id: 15, nombre: 'Torta matera', descripcion: 'Bizcocho seco, perfecto para acompañar el mate.', precio: 400, imagen: 'assets/img/productos/matera.webp' },
    { id: 16, nombre: 'Alfajor húmedo', descripcion: 'Alfajor de chocolate con relleno cremoso.', precio: 180, imagen: 'assets/img/productos/alfajor.jpg' },
